...
import { useExtendedAuth } from '@/react-app/components/AuthWrapper';
...
export default function HomePage() {
  ...
  const { user, redirectToLogin, logout, isPending } = useExtendedAuth();
        ...
        <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full border-2 border-gray-300 text-gray-700 py-2 px-4 rounded-lg hover:border-gray-400 hover:bg-gray-50 transition-all duration-200 font-medium"
            >
              Sign in with Email
            </button>
            ...
            <button
              ...
              className="w-full bg-gray-100 text-gray-700 py-2 px-4 rounded-lg hover:bg-gray-200 transition-all duration-200 font-medium"
            >
              Create an Account
            </button>
